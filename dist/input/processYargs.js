...
function processYargs() {
    ...
    const { argv } = yargs
        ...
        'use-env': {
            describe: 'Use environment variables (DB_HOST, DB_PORT, DB_NAME, DB_SCHEMAS) as defaults',
            default: false,
            type: 'boolean',
        },
    })
    ...
    return {
        ...
        port: useEnv && process.env.DB_PORT ? parseInt(process.env.DB_PORT, 10) : port,
        schemas: useEnv && process.env.DB_SCHEMAS ? process.env.DB_SCHEMAS : schemas,
